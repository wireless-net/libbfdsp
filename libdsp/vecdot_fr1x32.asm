 ...
 ******************************************************************************
  File name       :  vecdot_fr1x32.asm 
 
  Purpose         :  Real vector dot product for fractional data types.
  ...
  Description     :  This function multiplies each element of
                     ...
                     are fract16, result is fract32 with saturation. This
                     function returns the full precision result to allow
                     custom rounding schemes.
                 
  Registers used  :  Operands in  R0 & R1
                     R0 - Index to vector A
                     R1 - Index to vector B
                     R2 - No of elements 
                     R3,R4,I0,I1,P2,A0,A1
...
.file_attr libFunc       = vecdot_fr1x32;
.file_attr libFunc       = __vecdot_fr1x32;
.file_attr libName = libdsp;
.file_attr prefersMem    = internal;
.file_attr prefersMemNum = "30";
.file_attr FuncName      = __vecdot_fr1x32;
#endif
...
ST_VECDOT:     R0=(A0+=R4.L*R3.L) , R1=(A1+=R4.H*R3.H) || 
            ...
            /* at this point, R0/A0 contains even product sum, R4/A1 contains odd product sum */ 
...
.size __vecdot_fr1x32, .-__vecdot_fr1x32
