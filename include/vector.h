 ...
 */
        ...
        fract32 vecdot_fr1x32 (const fract16 _vector_x[], 
                               const fract16 _vector_y[], 
                               int _length) asm ("__vecdot_fr1x32");
        
        /* added by Lumenosys Robotics, April 2015. */ 
        fract16 vecdot_fr16_sr(const fract16 _vector_x[], 
                               const fract16 _vector_y[], 
                               int _length,
                               unsigned int srnd) asm ("__vecdot_fr16_sr");
